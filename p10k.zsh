# Generated by Powerlevel10k configuration wizard on 2025-07-30 at 10:15 EAT.
...
# 12h time, angled separators, slanted heads, slanted tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%2F\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%2F\uE0B3'
  ...
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=100
  # Custom icon.
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%1Ftook '
  ...
  typeset -g POWERLEVEL9K_DATE_FOREGROUND=white
